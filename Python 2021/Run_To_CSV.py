...
#cpmori addtion
#creating arrays for channel values
titles = []
titles.append("time (ns)")
channels = []
...
channels.append(adc2mVChAMax[:])
channels.append(adc2mVChBMax[:])
...
with open(file_name,'a') as f:
    ...
    writer.writerow(channels[0])
    writer.writerow(channels[1])
